...
import Patient from "../Pages/Dashboard/Main-Dashboard/AllPages/Doctor/patient";
...
import Patient_Profile from "../Pages/Dashboard/Main-Dashboard/AllPages/Nurse/Patient_Profile";
    ...
    <>
      ...
      //  <Route path="/addambulance" element={<Add_Ambulance />} />
        ...
        ******************** Nurse Part *************************
        ...
        <Route path="/patientprofile/:id" element={<Patient_Profile />} />
      </Routes>
    </>
  );
};
